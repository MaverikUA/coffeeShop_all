...
var _TaskForm = __webpack_require__(396);

var _ToDoList = __webpack_require__(398);
    ...
    _createClass(App, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(_ToDoList.ToDoList, null)
            );
        }
    }]);
...
var TaskForm = exports.TaskForm = function (_React$Component) {
    ...
    _createClass(TaskForm, [{
        ...
        value: function render() {
            return React.createElement(
                'form',
                { onSubmit: this.props.taskMethod },
                React.createElement('input', { type: 'text', name: 'mytask', className: 'input-task', placeholder: 'type your task' }),
                React.createElement(
                    'button',
                    null,
                    '\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u043A\u0443'
...
var ToDoList = exports.ToDoList = function (_React$Component) {
    ...
    _createClass(ToDoList, [{
        ...
        key: 'deleteTask',
        value: function deleteTask(task, e) {
            this.setState({
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(
                    'div',
                    { className: 'header' },
                    React.createElement('input', { className: 'input-task', onKeyPress: this.handleKeyPress.bind(this) })
                ),
                React.createElement(
                    'div',
                    { className: 'tasks' },
                    this.state.tasks.map(function (task) {
                        return React.createElement(
                            ...
                            React.createElement(
                                'span',
                                { className: 'delete', onClick: _this2.deleteTask.bind(_this2, task) },
                                'x'
                            )
                        );
                    })
